...
openai.api_key = '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'
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        default="D:/GitHub/LLM-EM0001/fm_data_tasks-main/fm_data_tasks/data/datasets/data_imputation/Restaurant",
    ...
    parser.add_argument(
        ...
        type=str,
        help="Which data directory to run.",
        default="outputs/Restaurant/validation/default/5k_0inst_0cb_random_200run_0dry/trial_0.feather",
        ##todo: It is possible to change the default --data_dir above
        ##required=True,
    )
    parser.add_argument(
    ...
    parser.add_argument("--k", type=int, help="Number examples in prompt", default=8)
    parser.add_argument(
        "--sample_method",
        type=str,
    ...
    parser.add_argument(
        "--max_tokens", type=int, help="Max tokens to generate.", default=2
    )
